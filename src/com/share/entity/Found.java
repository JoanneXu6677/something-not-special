...
public class Found {
	public int foundId; //标志字段4+（1失物招领/2寻物启事）
	...
	public Found(int foundId, String location, String pcPath, String time, String description, int userId,
			String contract) {
		super();
	...
	public String toString() {
		return "found [foundId=" + foundId + ", location=" + location + ", pcPath=" + pcPath + ", time=" + time
