...
public class Inter {
	...
	public int userId;
	public Inter(int actId, String topic, String title, String description, int likeCount, int commentCount,
	...
	public String toString() {
		return "Inter [actId=" + actId + ", topic=" + topic + ", title=" + title + ", description=" + description
				+ ", likeCount=" + likeCount + ", commentCount=" + commentCount + ", time=" + time + ", pcPath="
				+ pcPath + ", userId=" + userId + "]";
	}
