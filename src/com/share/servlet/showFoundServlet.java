...
public class showFoundServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			List<Found> resultList = service.GetFoundArticle(index);
			System.out.println(JSON.toJSONString(resultList));
			String foundJson = JSON.toJSONString(resultList);
			String resultStr = "{\"msg\":\"success\",\"data\":"+ foundJson +"}";
